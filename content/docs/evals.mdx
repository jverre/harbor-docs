...
In Harbor, a dataset is a collection of tasks in the [Harbor task format](/docs/task-format). Tasks are agentic environments consisting of an instruction, container environment, and test script.
